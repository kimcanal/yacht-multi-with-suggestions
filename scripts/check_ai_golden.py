...
GOLDEN_CASES = [
    {
        ...
        "expected": {
            ...
            "expected_value": 20.58,
            "breakdown_names": ["4 of a Kind", "Full House", "Small Straight"],
        },
    },
    {
    ...
    },
    {
        ...
        "expected": {
            ...
            "summary": "상단 보너스 추천: Sixes EV 77.8",
            "keep_indices": [0, 1, 2],
            "primary_target": "Sixes",
            "expected_value": 77.77,
            "breakdown_names": ["Sixes", "4 of a Kind", "Full House"],
        },
    },
    {
        ...
        "expected": {
            ...
            "strategy_mode": "focused",
            "message": "Sixes",
            "summary": "점수 기록 추천: Sixes 18점",
            "keep_indices": [],
            "primary_target": "Sixes",
            "expected_value": 73.70,
            "breakdown_names": ["Sixes", "Choice", "Yacht"],
        },
    },
    {
        ...
        "expected": {
            ...
            "strategy_mode": "focused",
            "message": "4 of a Kind",
            "summary": "점수 기록 추천: 4 of a Kind 20점",
            "keep_indices": [],
            "primary_target": "4 of a Kind",
            "expected_value": 126.00,
            "breakdown_names": ["4 of a Kind", "Full House", "Small Straight"],
        },
    },
]
