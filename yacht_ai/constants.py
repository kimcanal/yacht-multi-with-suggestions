...
SCORE_STAGE_QUALITY_WEIGHT = 0.35
...
SCORE_STAGE_UPPER_DUMP_MAX_COST = 2.75
SCORE_STAGE_UPPER_DUMP_MIN_FACE = 5
SCORE_STAGE_UPPER_DUMP_SACRIFICE_COST = 1.5
SCORE_STAGE_UPPER_DUMP_SPECIALTY_MARGIN = 2.0
SCORE_STAGE_UPPER_DUMP_TARGET_COUNT = 3
